...
class KIMLayer:
    ...
    def convert_image(self, n, input_data):
    ...
    def calculate(self, input_data, num_process):
        ...
        for n in range(num_inputs):
            self.convert_image(n, input_data)
...
class Model:
    ...
    def __init__(self, display, num_process):
        self.layers = []
    ...
    def fit(self, X, Y):
        for n, layer in enumerate(self.layers):
            ...
            X = layer.calculate(X, self.num_process)
            if self.display:
    ...
    def predict(self, test_X, test_Y):
        for layer in self.layers:
            if isinstance(layer, KernelLearningLayer):
                break
            test_X = layer.calculate(test_X, self.num_process)
