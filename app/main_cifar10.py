...
if __name__ == '__main__':
    ...
    model.add_layer(layers.KIMLayer(block_size=5, channels_next = 12, stride = 1, emb=emb, num_KIMlearn=100))
    model.add_layer(layers.AvgPoolingLayer(pool_size=2))
    model.add_layer(layers.KIMLayer(block_size=5, channels_next = 32, stride = 1, emb=emb, num_KIMlearn=100))
    model.add_layer(layers.AvgPoolingLayer(pool_size=2))
